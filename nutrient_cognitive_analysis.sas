...
/*** 5. Standardize Cognitive Scores ***/

proc standard data=work.cfq_h mean=0 std=1 out=cfq_std;

    var CFDCST1 CFDCST2 CFDCST3
        CFDCSR CFDAST CFDDS;

run;


/*** 6. Create Composite Cognitive T-Score ***/
...
data cfq_std;
    ...
    Z_Cognitive_Score =
        mean(of CFDCST1 CFDCST2 CFDCST3
                CFDCSR CFDAST CFDDS);

    Cognitive_T_Score =
        (Z_Cognitive_Score * 10) + 50;

run;


/*** 7. Merge Cognitive Scores with Factor Scores ***/
...
data final_analysis;
    ...
    label
        Factor1 = "Dense Processed Foods & Animal Protein"
        Factor2 = "Fiber-Rich Grains & Legumes"
        Factor3 = "Dairy"
        Factor4 = "Simple Carbs & Sugars"
        Factor5 = "Fruits & Vegetables"
        Factor6 = "Caffeinated Foods/Beverages";
...
proc reg data=final_analysis;
    ...
    title "Dietary Patterns and Cognitive Function";
